/** Built heritage sites — official catalog (LCI-aligned metadata) */
const BUILT_HERITAGE_SITES = [
  {
    id: "centennial",
  ...
  },
  {
    ...
    category: "built",
    categoryLabel: "Built Heritage",
    cover: "data/Built Heritage/City Hall/Photographs/Old/City Hall.jpg",
    description:
  ...
  {
    id: "mfgr",
    name: "MFGR Park and Baywalk",
    category: "built",
    categoryLabel: "Built Heritage",
    cover: "data/Built Heritage/MFGR Park and Baywalk/Map/map_baywalk.jpg",
    description:
  ...
  {
    id: "gabaldon",
    name: "Gabaldon Structure of RRMCES-1",
    category: "built",
    categoryLabel: "Built Heritage",
    cover:
  ...
  },
  {
    ...
    location: "Barangay Central, Capitol Hills",
    lat: 6.94425,
    lng: 126.248333,
